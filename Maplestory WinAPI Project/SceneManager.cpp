...
void SceneManager::Initialize()
{
	...
	//mScenes[(UINT)eSceneType::Boss_Stage1_Ani] = new Stage1_AniScene(); //º¸½ºÀÔ±¸ ¾À
	mScenes[(UINT)eSceneType::Boss_Stage1] = new Boss_Stage1_Scene(); //º¸½º½ºÅ×ÀÌÁö1 ¾À
	//mScenes[(UINT)eSceneType::Boss_Stage2_Ani] = new Stage2_AniScene(); //º¸½ºÀÔ±¸ ¾À
	mScenes[(UINT)eSceneType::Boss_Stage2] = new Boss_Stage2_Scene(); //º¸½º½ºÅ×ÀÌÁö2 ¾À

	mActiveScene = mScenes[(UINT)eSceneType::Start]; //¾À ½ÃÀÛ
