...
void SceneManager::Initialize()
{
	...
	mScenes[(UINT)eSceneType::ChannelSelect] = new ChannelSelectScene(); //Ã¤³Î ¼±ÅÃ ¾À
	mScenes[(UINT)eSceneType::CharSelect] = new CharacterSelectScene(); //Ä³¸¯ÅÍ ¼±ÅÃ ¾À
	...
	mScenes[(UINT)eSceneType::Boss_Stage1_Ani] = new Stage1Enter_AniScene(); // ÆäÀÌÁî1 ¾Ö´Ï
	mScenes[(UINT)eSceneType::Boss_Stage1] = new Boss_Stage1_Scene(); //º¸½º½ºÅ×ÀÌÁö1 ¾À
	mScenes[(UINT)eSceneType::Boss_Stage2_Ani] = new Stage2Enter_AniScene(); // ÆäÀÌÁî2 ¾Ö´Ï
	mScenes[(UINT)eSceneType::Boss_Stage2] = new Boss_Stage2_Scene(); //º¸½º½ºÅ×ÀÌÁö2 ¾À

	mActiveScene = mScenes[(UINT)eSceneType::Boss_Enter]; //¾À ½ÃÀÛ
